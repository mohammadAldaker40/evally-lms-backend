...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'student@example.com', description: 'User email address' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'STUDENT', enum: client_1.Role, required: false, description: 'User role (default: STUDENT)' }),
